...
public class SnowboardFree extends Applet implements  Runnable, KeyListener, FocusListener
{
...
class Rocks
{
	public int x;  //x and y coordinates for rocks.
	public int y;
	Image rockImage;
	...
	public void newRock(Random g1)  //Function for generating new rocks.
	{
	...
	public void moveRock(int y1, Random g1)  //Function for moving rocks.
	{
		y = y - y1;
		if(y < 2)  //New rock at bottom of screen if one leaves the top of the screen.
		{
			y = 498;
			x = (int)(g1.nextDouble() * 480) + 2;
		}
...
class Trees
{
	public int x;  //x and y coordinates for trees.
	public int y;
	Image treeImage;
	...
	public void newTree(Random g1)  //Function for generating new rocks.
	{
		do  //Loop keeps trees from generating on top of the snowboarder.
		{
			x = (int)(g1.nextDouble() * 480) + 2;
			y = (int)(g1.nextDouble() * 480) + 2;
		}
	...
	public void moveTree(int y1, Random g1)  //Function for moving rocks.
	{
		y = y - y1;
		if(y < 2)  //New tree at bottom of screen if one leaves the top of the screen.
		{
			y = 498;
			x = (int)(g1.nextDouble() * 480) + 2;
		}
